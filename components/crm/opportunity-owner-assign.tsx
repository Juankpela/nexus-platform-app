...
import type { OwnerOption } from "@/components/crm/opportunity-form-dialog"
import { assignOpportunityOwnerAction } from "@/modules/crm/presentation/opportunity-actions"
...
export function OpportunityOwnerAssign({
  tenantSlug,
  id,
  ownerId,
  ownerOptions,
