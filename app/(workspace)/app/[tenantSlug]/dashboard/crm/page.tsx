import { Building2, Contact, Percent, Target, TrendingUp } from "lucide-react"
...
export default async function CrmDashboardPage({
  ...
  return (
    <>
      <PageHeader title="Dashboard CRM" description="Pipeline comercial y conversión." />
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <SummaryWidget
            ...
            rows={stats.pipelineByStage.map((s) => ({
              ...
              value: s.count > 0 ? `${s.count} · ${fmt(s.value)}` : "—",
            }))}
          />
          <SummaryWidget
